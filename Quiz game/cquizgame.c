...
int main()
    ...
    system("cls");
     ...
     switch(r1)
		{
		case 1:
		printf("\n\nWho is he president of Bangladesh?");
		printf("\n\nA.Limon Halder\t\tB.Anup Biswas\n\nC.Mohammed Abdul Hamid\t\tD.Jason Baidya");
		if (toupper(getch())=='C')
			{
			    printf("\n\nCorrect!!!");count++;
			    getch();
		       ...
		       {
		           printf("\n\nWrong!!! The correct answer is C.Mohammed Abdul Hamid");
		           getch();
		       break;
		       }

        case 2:
		printf("\n\n\nWho develop this Quiz game?");
		printf("\n\nA. X\t\tB.Mr. Y\n\nC.Mr. Limon\t\tD.Mr. Z");
		if (toupper(getch())=='C')
			{printf("\n\nCorrect!!!");count++;
			getch();
			break;}
		       ...
		       {printf("\n\nWrong!!! The correct answer is C. Mr. Limon");
		       getch();
		       break;}
        ...
        case 4:
		printf("\n\n\nWho is the incharge of BBCS hostel?");
		printf("\n\nA. Mr. A\t\tMr. Bikash Baroi\n\nC. mr. Messi\t\tD.Mr. Ronaldo");
		if (toupper(getch())=='B')
			{printf("\n\nCorrect!!!");count++;
			getch();
			 break;}
		else
		       {printf("\n\nWrong!!! The correct answer is B. Bikash Baroi");
		       getch();
		       break;}

        case 5:
        printf("\n\n\nWhich is the first highest mountain in the world?");
        printf("\n\nA.Mt. xyz\t\tB.Mt. Everest\n\nC.Mt. yxz\t\tD.Mt. mno");
        if (toupper(getch())=='B')
               {printf("\n\nCorrect!!!");count++;
               getch();
                break;}
	...
	{
	system("cls");
	printf("\n\nSORRY YOU ARE A BOT SO YOU'RE NOT ELIGIBLE TO PLAY THIS GAME, BETTER LUCK NEXT TIME");
	getch();
	goto mainhome;
	}
     test:
		...
		if (toupper(getch())=='A')
			{printf("\n\nCorrect!!!");countr++;getch();
			 break;getch();}
		       ...
		       {printf("\n\nWrong!!! The correct answer is A.Football");getch();
		       goto score;
		       break;}

		case 2:
		printf("\n\n\nStudy of Computer Science is called............,");
		printf("\n\nA.CSE\t\tB.BBA\n\nC.BA\t\tD.B.Com");
		if (toupper(getch())=='A')
			{printf("\n\nCorrect!!!");countr++;getch();
			 break;}
		else
		       {printf("\n\nWrong!!! The correct answer is A.CSE");getch();
		      goto score;
		       break;
		       }
